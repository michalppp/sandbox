...
public class Grelin implements java.io.Serializable {
	...
	public Grelin(long pk, long grehdrpk, int purchaseorderline, long itemmasterpk, String itemnr, String dispatchnotesupplier, String outboundignore, Date recordcreationtime) {
		this.pk = pk;
	...
	public Grelin(long pk, long grehdrpk, Integer deliveryline, Date deliverydate, int purchaseorderline, Long goodsreceptionnote, Integer goodsreceptionnoteline,
	        String purchaseordernrDelannhdr, String purchaseordernrDelannlin, String purchaseorderlineDelann, long itemmasterpk, String itemnr, String itemnrcontractor,
	        BigDecimal orderquantity, BigDecimal purchaseprice, BigDecimal standardcost, BigDecimal amount, BigDecimal deliveredquantity, String stockkeepingunit,
	        String qualityapprovalflag, String batchflag, String serialnumbertrackingflag, String warehouse, String shipmentmarking, String transitdeliveryflag,
	        String directdeliveryflag, String dispatchnotesupplier, String supplieritemdesc, BigDecimal grossweight, BigDecimal netweight, BigDecimal grossvolume,
	        BigDecimal netvolume, String partialdeliveryflag, String deliverycompletedflag, Date confirmeddeliverydate, String programname, String filename,
	...
	@Column(name = "DISPATCHNOTESUPPLIER", nullable = false, length = 30)
	...
	@Temporal(TemporalType.TIMESTAMP)
	@Column(name = "CONFIRMEDDELIVERYDATE", length = 19)

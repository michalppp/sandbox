 ...
 */
@Entity
@Table(name = "SALE103AGG", uniqueConstraints = @UniqueConstraint(columnNames = { "CONTRDEFPK", "TDYEAR", "TDMONTH", "ITEMNR",
        "ITEMNRCONTRACTOR", "BIZPARADDRPK_DELIVERY", "BIZPARADDRPK_INVOICE" }))

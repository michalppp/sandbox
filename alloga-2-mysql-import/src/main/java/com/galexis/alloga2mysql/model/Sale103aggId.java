...
public class Sale103aggId implements java.io.Serializable {
	...
	public Sale103aggId(long contrdefpk, short tdyear, byte tdmonth, int actualperiod, String itemnr, String itemnrcontractor, Long bizparaddrpkDelivery, Long bizparaddrpkInvoice,

 ...
 */
@Entity
@Table(name = "PHASELOG", uniqueConstraints = @UniqueConstraint(columnNames = { "DAYENDRELEASEDATE", "CONTRDEFPK" }))
public class Phaselog implements java.io.Serializable {
	...
	public Phaselog(long pk, int dayendreleasedate, Long contrdefpk, String phase, Date validfrom, Date validto, Date considered, Date recordcreationtime) {
		this.pk = pk;
		this.dayendreleasedate = dayendreleasedate;

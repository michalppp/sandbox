...
public class Tourexg implements java.io.Serializable {
	...
	public Tourexg(long pk, String custglx, String custgln, String dispatchwarehouse, int dispatchdate, int dispatchtime, String tourid, int cutoffdate, int cutofftime,
	        char tourtype, String transactionid, Date recordcreationtime, char recordprocessedflag) {
		this.pk = pk;
	...
	public Tourexg(long pk, String custglx, String custgln, String dispatchwarehouse, int dispatchdate, int dispatchtime, String tourid, int cutoffdate, int cutofftime,
	        char tourtype, String transactionid, Date recordcreationtime, char recordprocessedflag, Date recordprocessingtime) {
		this.pk = pk;
		this.custglx = custglx;
		this.custgln = custgln;
		this.dispatchwarehouse = dispatchwarehouse;

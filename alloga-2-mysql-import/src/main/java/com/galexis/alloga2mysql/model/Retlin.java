...
public class Retlin implements java.io.Serializable {
	...
	public Retlin(long pk, long rethdrpk, int incidentline, long itemmasterpk, String itemnr, String outboundignore, Date recordcreationtime) {
		this.pk = pk;
	...
	public Retlin(long pk, long rethdrpk, int incidentline, Long salesordernr, Integer salesorderline, String salesordertype, Date orderdate, Long invoicenr,
	        Integer invoicelinenr, Long dellinpk, long itemmasterpk, String itemnr, String itemnrcontractor, BigDecimal returnedqty, String unit, String problemcode,
	        String problemcodedesc, String resolutioncode, String batchcontrolledflag, String qualitycontrolperformedflag, Date qualitycontroldate, Long newordernr,
	        Integer neworderline, BigDecimal refundpercentage, String freeofchargereasoncode, Integer ipSalesordertype, Integer ipInvoicetype, Integer ipFreeofchargereasoncode,
	        String ipGroupingcriteria1, String ipGroupingcriteria2, String ipGroupingcriteria3, String ipGroupingcriteria4, String ipGroupingcriteria5, String programname,
	        String filename, String processingflag1, String processingflag2, String processingflag3, String processingflag4, String processingflag5, String processingflag6,
	        String processingflag7, String processingflag8, String processingflag9, String processingflag10, String outboundignore, Date recordlastchangetime,
	...
	@Temporal(TemporalType.TIMESTAMP)
	@Column(name = "QUALITYCONTROLDATE", length = 19)

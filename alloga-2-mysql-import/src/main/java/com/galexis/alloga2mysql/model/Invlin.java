...
public class Invlin implements java.io.Serializable {
	...
	public Invlin(long pk, long invhdrpk, int invoiceline, long itemmasterpk, String itemnr, String outboundignore, Date recordcreationtime) {
		this.pk = pk;
	...
	public Invlin(long pk, long invhdrpk, int invoiceline, Integer accountingperiod, Long salesordernr, Integer orderline, Long dellinpk, long itemmasterpk, String itemnr,
	        String itemnrcontractor, String itemnrcontractor2, BigDecimal invoicedqty, BigDecimal orderqty, BigDecimal deliveredqty, BigDecimal naturaldiscountqty, String unit,
	        String batchcontrolledflag, BigDecimal salesprice, BigDecimal salesamount, BigDecimal netprice, BigDecimal netsalesvalue, BigDecimal orderdiscountpercentage,
	        String freeofchargeflag, String freeofchargereasoncode, String itempricecode, String itempricecodedesc, String salesrepresentative, BigDecimal standardcost,
	        BigDecimal totalamountexcludingvat, BigDecimal totalamountincludingvat, BigDecimal vatamount, String vathandlingcode, String vathandlingcodedesc,
	        BigDecimal vathandlingcodepercentage, String vatcodeflag, String vatincludedinpricesflag, String validfororderdiscountflag, Long generaldiscountkey,
	        Long salespricecalculationref, BigDecimal linecostvalue, String backorderflag, String reasoncode, String reasoncodedesc, Long reforiginalordernr,
	        Integer reforiginalorderline, Long reforiginalinvoicenr, Long incidentnumber, Integer incidentline, String incidentreasoncode, String orderingpartypurchordnumber,
	        String orderingpartypurchordline, String itemnarcoticcategory, String transitdeliveryflag, String directdeliveryflag, Short itemcompanynumber, String pricelist,
	        String pricelistdesc, BigDecimal priceaccordingtopricelist, BigDecimal priceaccordingtocustpricelist, BigDecimal manuallyenteredprice,
	        BigDecimal totaldiscountpercentage, String updatestockonhandflag, Integer ipFreeofchargereasoncode, String ipGroupingcriteria1, String ipGroupingcriteria2,
	        String ipGroupingcriteria3, String ipGroupingcriteria4, String ipGroupingcriteria5, String programname, String filename, String processingflag1,

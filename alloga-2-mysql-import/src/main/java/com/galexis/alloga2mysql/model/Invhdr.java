...
public class Invhdr implements java.io.Serializable {
	...
	public Invhdr(long pk, long contrdefpk, long invoicenr, boolean invoicetype, Date invoicedate, short invoiceyear, long bizparaddrpkOrder, String backendreleased,
	...
	public Invhdr(long pk, long contrdefpk, long invoicenr, boolean invoicetype, Date invoicedate, short invoiceyear, String salesorganisation, String salesorganisationdesc,
	        Long salesordernr, String salesordertype, Date salesorderdate, Long delhdrpk, String deliverynr, long bizparaddrpkOrder, Long bizparaddrpkInvoice,
	        Long bizparaddrpkDelivery, Long bizparaddrpkDebtor, String debtorcustomercontractor, String contractorsalesorganisation, String contractordivision,
	        String primarycurrency, BigDecimal discountbase, BigDecimal orderlinestotal, BigDecimal ordertotal, BigDecimal invoiceamountexcludingvat, BigDecimal vatamount,
	        BigDecimal invoiceamountincludingvat, BigDecimal invoiceadjustmentamount, BigDecimal invoicediscountamount, BigDecimal invoicefreightamount, String termsofpaymentcode,
	        String termsofpaymentdesc, Date duedate, Short termsofpaymentcreditdays, String mergeinvoicecode, String orderSourceCode, String withmovement, String vathandlingcode1,
	        BigDecimal vathandlingcodepercentage1, BigDecimal vatamount1, BigDecimal vatbaseamount1, String vathandlingcode2, BigDecimal vathandlingcodepercentage2,
	        BigDecimal vatamount2, BigDecimal vatbaseamount2, String vathandlingcode3, BigDecimal vathandlingcodepercentage3, BigDecimal vatamount3, BigDecimal vatbaseamount3,
	        String vathandlingcode4, BigDecimal vathandlingcodepercentage4, BigDecimal vatamount4, BigDecimal vatbaseamount4, Integer ipSalesordertype, Integer ipInvoicetype,
	        Character ipIssaleswithmovement, Character ipIsdebit, Integer timedatepk, Integer ipTimedatepkReporting, String programname, String filename, String processingflag1,

...
public class Consordldt implements java.io.Serializable {
	...
	public Consordldt(long pk, long conslinpk, long conshdrpk, int lineseq, String outboundignore, Date recordcreationtime) {
		this.pk = pk;
		this.conslinpk = conslinpk;
	...
	public Consordldt(long pk, long conslinpk, long conshdrpk, int lineseq, BigDecimal orderqty, Long originalordernr, Integer originalorderline, String programname,
	...
	@Column(name = "CONSLINPK", nullable = false, precision = 12, scale = 0)
	public long getConslinpk() {
		return this.conslinpk;
	}

	public void setConslinpk(long conslinpk) {
		this.conslinpk = conslinpk;
	}

...
/**
 * TrLgProcId generated by hbm2java
 */
@Embeddable
public class TrLgProcId implements java.io.Serializable {
	...
	public TrLgProcId(Date crTime, String serverId, String appId, String tag, String messagetyp, String messagever, String taskId, String refId, String transId, String partnerId,
	        String clientId, char severity, String info, String summary) {
		this.crTime = crTime;
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TrLgProcId)) return false;
		TrLgProcId castOther = (TrLgProcId) other;
		...
		return ((this.getCrTime() == castOther.getCrTime()) || (this.getCrTime() != null && castOther.getCrTime() != null && this.getCrTime().equals(castOther.getCrTime())))
		        && ((this.getServerId() == castOther.getServerId()) || (this.getServerId() != null && castOther.getServerId() != null && this.getServerId().equals(
		                castOther.getServerId())))
		        ...
		        && ((this.getClientId() == castOther.getClientId()) || (this.getClientId() != null && castOther.getClientId() != null && this.getClientId().equals(
		                castOther.getClientId())))

...
public class Testlf  implements java.io.Serializable {
    ...
    public TestlfId getId() {
        return this.id;
    }
    
    public void setId(TestlfId id) {
        this.id = id;
    }

...
/**
 * Trlgdt2cpyId generated by hbm2java
 */
@Embeddable
public class Trlgdt2cpyId  implements java.io.Serializable {
    ...
    public Trlgdt2cpyId(Date crTime, String appId, String tag, String taskId, String transId, char severity, byte[] databin, int segmNo, String summary, String messagetyp) {
       this.crTime = crTime;
       this.appId = appId;
       this.tag = tag;
       this.taskId = taskId;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof Trlgdt2cpyId) ) return false;
		 Trlgdt2cpyId castOther = ( Trlgdt2cpyId ) other; 

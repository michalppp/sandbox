...
/**
 * Tr4lgProcId generated by hbm2java
 */
@Embeddable
public class Tr4lgProcId  implements java.io.Serializable {
    ...
    public Tr4lgProcId(Date crTime, String serverId, String appId, String tag, String messagetyp, String messagever, String taskId, String refId, String transId, String partnerId, String clientId, char severity, String info, String summary) {
       this.crTime = crTime;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof Tr4lgProcId) ) return false;
		 Tr4lgProcId castOther = ( Tr4lgProcId ) other; 

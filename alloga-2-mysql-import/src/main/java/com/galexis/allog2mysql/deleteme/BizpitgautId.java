...
/**
 * BizpitgautId generated by hbm2java
 */
@Embeddable
public class BizpitgautId  implements java.io.Serializable {
    ...
    public BizpitgautId(long pk, long bizpmasterpk, Date recordcreationtime) {
        this.pk = pk;
        this.bizpmasterpk = bizpmasterpk;
        this.recordcreationtime = recordcreationtime;
    }
    public BizpitgautId(long pk, long bizpmasterpk, String authorizationkey, String isactiveflag, String programname, String filename, Date recordlastchangetime, Date recordcreationtime) {
       this.pk = pk;
       this.bizpmasterpk = bizpmasterpk;
    ...
    @Column(name="AUTHORIZATIONKEY", length=10)
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof BizpitgautId) ) return false;
		 BizpitgautId castOther = ( BizpitgautId ) other; 
         
		 return (this.getPk()==castOther.getPk())
 && (this.getBizpmasterpk()==castOther.getBizpmasterpk())
 && ( (this.getAuthorizationkey()==castOther.getAuthorizationkey()) || ( this.getAuthorizationkey()!=null && castOther.getAuthorizationkey()!=null && this.getAuthorizationkey().equals(castOther.getAuthorizationkey()) ) )
 ...
 && ( (this.getRecordcreationtime()==castOther.getRecordcreationtime()) || ( this.getRecordcreationtime()!=null && castOther.getRecordcreationtime()!=null && this.getRecordcreationtime().equals(castOther.getRecordcreationtime()) ) );
   ...
   public int hashCode() {
         ...
         result = 37 * result + ( getAuthorizationkey() == null ? 0 : this.getAuthorizationkey().hashCode() );

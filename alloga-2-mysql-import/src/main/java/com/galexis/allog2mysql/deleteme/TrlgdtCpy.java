...
/**
 * TrlgdtCpy generated by hbm2java
 */
@Entity
@Table(name="TRLGDT_CPY"
    ,schema="INTEGAP"
    ,catalog="CHGALE11RDB"
)
public class TrlgdtCpy  implements java.io.Serializable {


     private TrlgdtCpyId id;

    public TrlgdtCpy() {
    }

    public TrlgdtCpy(TrlgdtCpyId id) {
       this.id = id;
    }
    ...
    public TrlgdtCpyId getId() {
        return this.id;
    }
    
    public void setId(TrlgdtCpyId id) {
        this.id = id;
    }

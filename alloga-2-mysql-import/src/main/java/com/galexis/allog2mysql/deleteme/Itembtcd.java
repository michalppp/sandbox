...
public class Itembtcd  implements java.io.Serializable {
    ...
    public Itembtcd(long pk, long contrdefpk, Long interfacemessagedocumentnumber, String businesspartneridentifier, String sendingpartnereancode, String documentactioncode, String interfacemessagetype, Date batchexpirydate, String batchid, String batchidcontractor, Character isbatchrestricted, String itemnrcontractor, Date batchproductiondate, Character processingflag1, Character processingflag2, Character processingflag3, Character processingflag4, Character processingflag5, Character processingflag6, Character processingflag7, Character processingflag8, Character processingflag9, Character processingflag10, String programname, String filename, Character backendreleased, Character outboundignore, String transactionid, String transactionid2, Character recordprocessedflag, Date recordprocessingtime, Date recordlastchangetime, Date recordcreationtime) {
       this.pk = pk;
       this.contrdefpk = contrdefpk;
    ...
    @Column(name="BATCHEXPIRYDATE", length=10)
    ...
    @Temporal(TemporalType.DATE)
    @Column(name="BATCHPRODUCTIONDATE", length=10)
    ...
    @Column(name="TRANSACTIONID2", length=50)

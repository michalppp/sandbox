...
/**
 * Trlgdt2cpy generated by hbm2java
 */
@Entity
@Table(name="TRLGDT2CPY"
    ,schema="INTEGAP"
    ,catalog="CHGALE11RDB"
)
public class Trlgdt2cpy  implements java.io.Serializable {


     private Trlgdt2cpyId id;

    public Trlgdt2cpy() {
    }

    public Trlgdt2cpy(Trlgdt2cpyId id) {
       this.id = id;
    }
    ...
    public Trlgdt2cpyId getId() {
        return this.id;
    }
    
    public void setId(Trlgdt2cpyId id) {
        this.id = id;
    }

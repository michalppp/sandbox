...
/**
 * Tr8lgProcId generated by hbm2java
 */
@Embeddable
public class Tr8lgProcId  implements java.io.Serializable {
    ...
    public Tr8lgProcId(Date crTime, String serverId, String appId, String tag, String messagetyp, String messagever, String taskId, String refId, String transId, String partnerId, String clientId, char severity, String info, String summary) {
       this.crTime = crTime;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof Tr8lgProcId) ) return false;
		 Tr8lgProcId castOther = ( Tr8lgProcId ) other; 

...
/**
 * TralgProc generated by hbm2java
 */
@Entity
@Table(name="TRALG_PROC"
    ,schema="INTEGAP"
    ,catalog="CHGALE11RDB"
)
public class TralgProc  implements java.io.Serializable {


     private TralgProcId id;

    public TralgProc() {
    }

    public TralgProc(TralgProcId id) {
       this.id = id;
    }
    ...
    public TralgProcId getId() {
        return this.id;
    }
    
    public void setId(TralgProcId id) {
        this.id = id;
    }

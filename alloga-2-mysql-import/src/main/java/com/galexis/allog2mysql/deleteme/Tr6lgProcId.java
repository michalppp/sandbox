...
/**
 * Tr6lgProcId generated by hbm2java
 */
@Embeddable
public class Tr6lgProcId  implements java.io.Serializable {
    ...
    public Tr6lgProcId(Date crTime, String serverId, String appId, String tag, String messagetyp, String messagever, String taskId, String refId, String transId, String partnerId, String clientId, char severity, String info, String summary) {
       this.crTime = crTime;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof Tr6lgProcId) ) return false;
		 Tr6lgProcId castOther = ( Tr6lgProcId ) other; 

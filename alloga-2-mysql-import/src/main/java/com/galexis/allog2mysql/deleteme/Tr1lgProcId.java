...
/**
 * Tr1lgProcId generated by hbm2java
 */
@Embeddable
public class Tr1lgProcId  implements java.io.Serializable {
    ...
    public Tr1lgProcId(Date crTime, String serverId, String appId, String tag, String messagetyp, String messagever, String taskId, String refId, String transId, String partnerId, String clientId, char severity, String info, String summary) {
       this.crTime = crTime;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof Tr1lgProcId) ) return false;
		 Tr1lgProcId castOther = ( Tr1lgProcId ) other; 

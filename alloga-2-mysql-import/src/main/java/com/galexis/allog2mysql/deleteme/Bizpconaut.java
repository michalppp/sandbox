...
public class Bizpconaut  implements java.io.Serializable {
    ...
    public Bizpconaut(BizpconautId id, Contrdef contrdef, Bizpmaster bizpmaster) {
       this.id = id;
    ...
    public BizpconautId getId() {
        return this.id;
    }
    
    public void setId(BizpconautId id) {
        this.id = id;
    }

...
/**
 * Sale103agg generated by hbm2java
 */
@Entity
@Table(name="SALE103AGG"
    ,schema="INTEGAP"
    ,catalog="CHGALE11RDB"
    , uniqueConstraints = @UniqueConstraint(columnNames={"CONTRDEFPK", "TDYEAR", "TDMONTH", "ITEMNR", "ITEMNRCONTRACTOR", "BIZPARADDRPK_DELIVERY", "BIZPARADDRPK_INVOICE"}) 
)
public class Sale103agg  implements java.io.Serializable {


     private Sale103aggId id;

    public Sale103agg() {
    }

    public Sale103agg(Sale103aggId id) {
       this.id = id;
    }
    ...
    public Sale103aggId getId() {
        return this.id;
    }
    
    public void setId(Sale103aggId id) {
        this.id = id;
    }

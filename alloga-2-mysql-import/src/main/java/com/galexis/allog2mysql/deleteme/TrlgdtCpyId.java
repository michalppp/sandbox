...
/**
 * TrlgdtCpyId generated by hbm2java
 */
@Embeddable
public class TrlgdtCpyId  implements java.io.Serializable {
    ...
    public TrlgdtCpyId(Date crTime, String appId, String tag, String taskId, String transId, char severity, byte[] databin, int segmNo, String summary, String messagetyp) {
       this.crTime = crTime;
       this.appId = appId;
       this.tag = tag;
       this.taskId = taskId;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof TrlgdtCpyId) ) return false;
		 TrlgdtCpyId castOther = ( TrlgdtCpyId ) other; 

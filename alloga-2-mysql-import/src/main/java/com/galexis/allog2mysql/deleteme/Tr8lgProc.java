...
/**
 * Tr8lgProc generated by hbm2java
 */
@Entity
@Table(name="TR8LG_PROC"
    ,schema="INTEGAP"
    ,catalog="CHGALE11RDB"
)
public class Tr8lgProc  implements java.io.Serializable {


     private Tr8lgProcId id;

    public Tr8lgProc() {
    }

    public Tr8lgProc(Tr8lgProcId id) {
       this.id = id;
    }
    ...
    public Tr8lgProcId getId() {
        return this.id;
    }
    
    public void setId(Tr8lgProcId id) {
        this.id = id;
    }

...
/**
 * Tr1lgProc generated by hbm2java
 */
@Entity
@Table(name="TR1LG_PROC"
    ,schema="INTEGAP"
    ,catalog="CHGALE11RDB"
)
public class Tr1lgProc  implements java.io.Serializable {


     private Tr1lgProcId id;

    public Tr1lgProc() {
    }

    public Tr1lgProc(Tr1lgProcId id) {
       this.id = id;
    }
    ...
    public Tr1lgProcId getId() {
        return this.id;
    }
    
    public void setId(Tr1lgProcId id) {
        this.id = id;
    }

...
/**
 * Tr9lgProc generated by hbm2java
 */
@Entity
@Table(name="TR9LG_PROC"
    ,schema="INTEGAP"
    ,catalog="CHGALE11RDB"
)
public class Tr9lgProc  implements java.io.Serializable {


     private Tr9lgProcId id;

    public Tr9lgProc() {
    }

    public Tr9lgProc(Tr9lgProcId id) {
       this.id = id;
    }
    ...
    public Tr9lgProcId getId() {
        return this.id;
    }
    
    public void setId(Tr9lgProcId id) {
        this.id = id;
    }

...
/**
 * Tr1lgStatId generated by hbm2java
 */
@Embeddable
public class Tr1lgStatId  implements java.io.Serializable {
    ...
    public Tr1lgStatId(Date crTime, String serverId, String appId, String tag, String messagetyp, String messagever, String taskId, String refId, String transId, int time, int count, int aggCount, String info, String summary) {
       this.crTime = crTime;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof Tr1lgStatId) ) return false;
		 Tr1lgStatId castOther = ( Tr1lgStatId ) other; 

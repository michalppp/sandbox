...
/**
 * Tr4lgProc generated by hbm2java
 */
@Entity
@Table(name="TR4LG_PROC"
    ,schema="INTEGAP"
    ,catalog="CHGALE11RDB"
)
public class Tr4lgProc  implements java.io.Serializable {


     private Tr4lgProcId id;

    public Tr4lgProc() {
    }

    public Tr4lgProc(Tr4lgProcId id) {
       this.id = id;
    }
    ...
    public Tr4lgProcId getId() {
        return this.id;
    }
    
    public void setId(Tr4lgProcId id) {
        this.id = id;
    }

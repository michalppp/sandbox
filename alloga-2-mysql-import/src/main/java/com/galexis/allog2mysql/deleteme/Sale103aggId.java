...
/**
 * Sale103aggId generated by hbm2java
 */
@Embeddable
public class Sale103aggId  implements java.io.Serializable {
    ...
    public Sale103aggId(long contrdefpk, short tdyear, byte tdmonth, int actualperiod, String itemnr, String outboundignore, String recordprocessedflag, Date recordcreationtime) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof Sale103aggId) ) return false;
		 Sale103aggId castOther = ( Sale103aggId ) other; 

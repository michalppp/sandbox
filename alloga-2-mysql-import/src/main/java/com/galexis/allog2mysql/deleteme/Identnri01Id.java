...
/**
 * Identnri01Id generated by hbm2java
 */
@Embeddable
public class Identnri01Id  implements java.io.Serializable {
    ...
    public Identnri01Id(long pk, String filename, long lastidentifier, Date recordlastchangetime) {
       this.pk = pk;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof Identnri01Id) ) return false;
		 Identnri01Id castOther = ( Identnri01Id ) other; 

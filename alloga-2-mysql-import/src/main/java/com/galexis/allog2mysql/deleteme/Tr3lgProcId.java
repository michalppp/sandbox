...
/**
 * Tr3lgProcId generated by hbm2java
 */
@Embeddable
public class Tr3lgProcId  implements java.io.Serializable {
    ...
    public Tr3lgProcId(Date crTime, String serverId, String appId, String tag, String messagetyp, String messagever, String taskId, String refId, String transId, String partnerId, String clientId, char severity, String info, String summary) {
       this.crTime = crTime;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof Tr3lgProcId) ) return false;
		 Tr3lgProcId castOther = ( Tr3lgProcId ) other; 

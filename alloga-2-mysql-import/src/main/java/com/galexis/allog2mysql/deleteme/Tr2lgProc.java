...
/**
 * Tr2lgProc generated by hbm2java
 */
@Entity
@Table(name="TR2LG_PROC"
    ,schema="INTEGAP"
    ,catalog="CHGALE11RDB"
)
public class Tr2lgProc  implements java.io.Serializable {


     private Tr2lgProcId id;

    public Tr2lgProc() {
    }

    public Tr2lgProc(Tr2lgProcId id) {
       this.id = id;
    }
    ...
    public Tr2lgProcId getId() {
        return this.id;
    }
    
    public void setId(Tr2lgProcId id) {
        this.id = id;
    }

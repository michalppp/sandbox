...
/**
 * TralgProcId generated by hbm2java
 */
@Embeddable
public class TralgProcId  implements java.io.Serializable {
    ...
    public TralgProcId(Date crTime, String serverId, String appId, String tag, String messagetyp, String messagever, String taskId, String refId, String transId, String partnerId, String clientId, char severity, String info, String summary) {
       this.crTime = crTime;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof TralgProcId) ) return false;
		 TralgProcId castOther = ( TralgProcId ) other; 

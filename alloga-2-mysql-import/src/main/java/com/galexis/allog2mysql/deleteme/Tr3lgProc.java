...
/**
 * Tr3lgProc generated by hbm2java
 */
@Entity
@Table(name="TR3LG_PROC"
    ,schema="INTEGAP"
    ,catalog="CHGALE11RDB"
)
public class Tr3lgProc  implements java.io.Serializable {


     private Tr3lgProcId id;

    public Tr3lgProc() {
    }

    public Tr3lgProc(Tr3lgProcId id) {
       this.id = id;
    }
    ...
    public Tr3lgProcId getId() {
        return this.id;
    }
    
    public void setId(Tr3lgProcId id) {
        this.id = id;
    }

...
/**
 * Tr7lgProcId generated by hbm2java
 */
@Embeddable
public class Tr7lgProcId  implements java.io.Serializable {
    ...
    public Tr7lgProcId(Date crTime, String serverId, String appId, String tag, String messagetyp, String messagever, String taskId, String refId, String transId, String partnerId, String clientId, char severity, String info, String summary) {
       this.crTime = crTime;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof Tr7lgProcId) ) return false;
		 Tr7lgProcId castOther = ( Tr7lgProcId ) other; 

...
/**
 * TrLgStat generated by hbm2java
 */
@Entity
@Table(name="TR_LG_STAT"
    ,schema="INTEGAP"
    ,catalog="CHGALE11RDB"
)
public class TrLgStat  implements java.io.Serializable {


     private TrLgStatId id;

    public TrLgStat() {
    }

    public TrLgStat(TrLgStatId id) {
       this.id = id;
    }
    ...
    public TrLgStatId getId() {
        return this.id;
    }
    
    public void setId(TrLgStatId id) {
        this.id = id;
    }
